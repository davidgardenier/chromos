...
scatterstyle= [graph.style.symbol(size=0.1, symbolattrs=[color.gradient.RedBlue])]
...
g.writePDFfile('/scratch/david/master_project/plots/publication/presentation/cc_ns_states')
#------------------------------------------------------------------------------
...
errstyle= [graph.style.symbol(graph.style.symbol.changesquare, size=0.1, symbolattrs=[color.gradient.RedBlue]),
           graph.style.errorbar(size=0,errorbarattrs=[color.gradient.RedBlue])]
...
g.writePDFfile('/scratch/david/master_project/plots/publication/presentation/pcc_ns_states')
