...
def plot_allpcs():
    ...
    for i, o in enumerate(unknown):
        ...
        x_unknown.extend(hues)
        y_unknown.extend(hardness)
        xerror_unknown.extend(hues_err)
        yerror_unknown.extend(hardness_err)
    ...
    g = graph.graphxy(height=7,
                      ...
                      y=graph.axis.lin(min=0.4, max=1.5, title=r"Hardness"),
